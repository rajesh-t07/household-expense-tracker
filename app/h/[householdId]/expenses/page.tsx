...
export default function ExpensesPage({ params }: { params: { householdId: string } }) {
  ...
  return (
    <main className="mx-auto max-w-5xl p-8">
      ...
      <section className="mt-5 rounded border bg-white p-4">
        <h2 className="mb-3 font-semibold">Expense List</h2>
            ...
            <li key={expense._id} className="flex items-center justify-between rounded border p-2">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link
                  ...
                  href={`/h/${params.householdId}/expenses/${expense._id}` as any}
                >
                  View
                </Link>
              </div>
